...
const isFirstColumn = (rowData, rowID) => rowData.column !== undefined ? rowData.column === 0 : rowID % 2 === 0;
...
export default class Timeline extends Component {
  ...
  _renderRow(rowData, sectionID, rowID) {
    ...
    switch(this.props.columnFormat){
      ...
      break
      case 'two-column':
        content = isFirstColumn(rowData,rowID) ? (
          <View style={[styles.rowContainer, this.props.rowContainerStyle]}>
            {this.renderTime(rowData, sectionID, rowID)}
            {this.renderEvent(rowData, sectionID, rowID)}
            {this.renderCircle(rowData, sectionID, rowID)}
  ...
  _renderTime(rowData, sectionID, rowID) {
      ...
      switch(this.props.columnFormat){
        ...
        case 'two-column':
          timeWrapper = {
            flex:1,
            alignItems: isFirstColumn(rowData,rowID)?'flex-end':'flex-start'
          }
        break
      }     
      return (
  ...
  _renderEvent(rowData, sectionID, rowID){
    ...
    switch(this.props.columnFormat){
      ...
      break
      case 'two-column':
        opStyle = isFirstColumn(rowData,rowID)?{
          borderColor: lineColor, 
          borderLeftWidth: lineWidth,
          borderRightWidth: 0,
          marginLeft: 20,
